...
# Creates initial database ./instance/recipe.db    
...
def add_recipe():
    ...
    # ensure client fields have been populated
    ...
    # serialization, transforming recipe back into JSON 
    new_recipe_data = {
        'id': new_recipe.id,
